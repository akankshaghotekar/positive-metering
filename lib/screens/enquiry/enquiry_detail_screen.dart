...
class _EnquiryDetailScreenState extends State<EnquiryDetailScreen> {
  ...
  Future<void> loadData() async {
    ...
    if (details != null) {
      ...
      if (details.followupDate != null && details.followupDate!.isNotEmpty) {
        followupDate = DateFormat('dd-MMM-yyyy').parse(details.followupDate!);
      }
      ...
      /// PRODUCTS
      selectedProducts = details.productSrNo.split(",");
    }
